...
def main(args_env):
    env = CsimRLEnv(model_path=args_env["model_path"],
                    server_address=args_env["server_address"])
    env.env_loop()


if __name__ == "__main__":
    args = {"name": sys.argv[1], "model_path": sys.argv[2], "server_address": sys.argv[3]}
    try:
        main(args)
    except:
